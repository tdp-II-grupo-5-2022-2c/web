...
export function getMexicoPlayersData() {
  return [
    {id: 1, name: "Guillermo Ochoa", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200"},
    {id: 2, name: "Néstor Araújo", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200"},
    {id: 3, name: "Jesús Gallardo", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200"},
    {id: 4, name: "César Montes", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200"},
    {id: 5, name: "Jorge Sánchez", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200", isInAlbum: true},
    {id: 6, name: "Edson Alvarez", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200", isInExchange: true},
    {id: 7, name: "Jesús Manuel Corona", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200", isInAlbum: true, isInExchange: true },
    {id: 8, name: "Héctor Herrera", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200"},
    {id: 9, name: "Carlos Rodriguez", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200"},
    {id: 10, name: "Raúl Jiménez", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200"},
    {id: 11, name: "Hirving Lozano", dateOfBirth: new Date(), weight: 72, height: 170,  position: "CF", country: "Mexico", image: "https://picsum.photos/300/200"},
  ] as IPlayer[]
}
